...
//
{
  ...
  {
    value = ( double ) arc4random ( ) / ( double ) RAND_MAX;
  }
...
double *r8mat_upsol ( int n, double*, double b[] )
...
double r8vec_multinormal_pdf ( unsigned long n, double mu[], double r[], double c_det,
  double x[] )
...
//  = y' * y.
//
  xcx = r8vec_dot_product ( (int) n, y, y );
